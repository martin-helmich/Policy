...
====================  ============  ==========
`Olivier Dobberkau`_  Asynchronous  <✅ Yes | ❌ No | ⚪ Abstain>
`Stefan Busemann`_    In meeting    <✅ Yes | ❌ No | ⚪ Abstain>
`Boris Hinzer`_       Not attended  <✅ Yes | ❌ No | ⚪ Abstain>
`Rachel Foucard`_     In meeting    <✅ Yes | ❌ No | ⚪ Abstain>
`Martin Helmich`_     Asynchronous  <✅ Yes | ❌ No | ⚪ Abstain>
`Jana Höffner`_       In meeting    <✅ Yes | ❌ No | ⚪ Abstain>
`Thomas Maroschik`_   Asynchronous  <✅ Yes | ❌ No | ⚪ Abstain>
====================  ============  ==========
